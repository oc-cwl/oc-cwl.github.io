...
> Occultum must be [Helium-3](https://en.wikipedia.org/wiki/Helium-3) or less likely [Tritium](https://en.wikipedia.org/wiki/Tritium). Kalon = [Thulium](https://en.wikipedia.org/wiki/Thulium). The "meta" elements are isotopes, e.g. Neon-20 and Neon-22 are the top 2 stable [Neon isotopes](https://en.wikipedia.org/wiki/Isotopes_of_neon). Metargon = [Argon-42](https://en.wikipedia.org/wiki/Isotopes_of_argon) - a rare isotope of Argon with half-life 33 years. Meta-Krypton is probably [Krypton-84](https://en.wikipedia.org/wiki/Isotopes_of_krypton). Meta-Xenon must be [Xenon-130](https://en.wikipedia.org/wiki/Isotopes_of_xenon). Platinum A/B are [isotopes of Platinum](https://en.wikipedia.org/wiki/Isotopes_of_platinum).

# The Ultimate Physical Atom

![](/img/anu.png)

_Plate II. MALE (left) and FEMALE (right)._

> These two might correspond to electron and positron.
...
_Types of Hyper-Meta-Proto-Elemental Matter (E2)._
...
_Types of Meta-Proto-Elemental Matter (E3)._
...
_Types of Proto-Elemental Matter (E4)._
